...
def main():
    ...
    parameters = pandas.read_excel(args.params_path, sheet_name="kinesin", usecols=[0, 1])
    ...
    kinesin_simulation.simulation.run(int(parameters["total_steps"]), parameters["timestep"])
