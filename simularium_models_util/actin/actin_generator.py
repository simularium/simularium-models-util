...
class ActinGenerator:
    ...
    @staticmethod
    def get_neighbor_actin_id(particle_id, direction, actin_number_types, particles):
        """
        ...
        for neighbor_id in neighbor_ids:
            ...
            goal_actin_number = ActinGenerator.get_actin_number(actin_number, actin_number_types, direction)
    ...
    def remove_mother_mid_at_junction(
        ...
        actin_mother0_id = ActinGenerator.get_neighbor_actin_id(
            actin_arp_ids[0], -1, actin_number_types, particles
        )
        actin_mother3_id = ActinGenerator.get_neighbor_actin_id(
            actin_arp_ids[1], 1, actin_number_types, particles
        )
        actin_mother4_id = ActinGenerator.get_neighbor_actin_id(
            actin_mother3_id, 1, actin_number_types, particles
        )
    ...
    def add_bound_arp_monomers(
        ...
        for a in range(len(fiber.bound_arps)):
            ...
            particles = ActinGenerator.remove_mother_mid_at_junction(
                [actin_arp2_id, actin_arp3_id], actin_number_types, particles
            )
        return particles, particle_ids
    ...
    def get_monomers_for_daughter_fiber(
        ...
        """
        print(
            f"""for (below), get_monomers_for_fiber gets actin_number_types from
            get_monomers_for_daughter_fiber where actin_number_types = {actin_number_types}, 
            only place where get_monomers_for_fiber is assigned a wrong actin_number_types#"""
            )
        (
            fork_positions,
            v_branch_shift,
    ...
    def get_main_monomers_for_fiber(
        ...
        """
        actin_number = pointed_actin_number
        print(f"line 459 extra; actin_number_types in get_main_monomers_for_fiber = {actin_number_types}")
        if not fiber.is_daughter and len(fiber.nucleated_arps) > 0:
            ...
            print(f"line 530; get_main_monomers_for_fiber: actin number types = {actin_number_types}")
    ...
    def get_monomers_for_fiber(
        ...
        for a in range(len(fiber.nucleated_arps)):
            ...
            (
                ...
                fiber, nucleated_arp, offset_vector, actin_number_types, particles
            )
            (
                particles,
                actin_arp_ids,
    ...
    @staticmethod
    def get_monomers(
        fibers_data, actin_number_types, child_box_center=None, child_box_size=None, use_uuids=True
    ):
        """
