...
class ActinStructure:
    ...
    def mother_fiber():
        ...
        axis_position0 = ActinStructure.mother_axis_point + ActinStructure.mother_axis_direction * d0
        ...
        axis_position1 = ActinStructure.mother_axis_point + ActinStructure.mother_axis_direction * d1
        normal = ReaddyUtil.get_random_perpendicular_vector(ActinStructure.mother_axis_direction)
        arc_length = np.linalg.norm(axis_position1 - axis_position0)
        return FiberData(0, [
            CurvePointData(
                axis_position0, ActinStructure.mother_axis_direction, 0
            ),
            CurvePointData(
    ...
    def actin_distance_from_axis(): # was 1.59 nm
        ...
        axis_position = mother_fiber.get_nearest_position(ActinStructure.mother_positions[0])
    ...
    def branch_positions():
        ...
        perpendicular = np.cross(ActinStructure.daughter_axis_direction, ActinStructure.mother_axis_direction)
        ...
        return [
            ActinStructure.mother_axis_point + t[0] * ActinStructure.mother_axis_direction,
            ActinStructure.daughter_axis_point + t[1] * ActinStructure.daughter_axis_direction,
        ]
    ...
    def actin_to_actin_distance(): # was 4.27 nm
        ...
        for i in range(len(ActinStructure.mother_positions)-1):
            distances.append(np.linalg.norm(ActinStructure.mother_positions[i + 1] - ActinStructure.mother_positions[i]))
        return np.mean(np.array(distances))

    @staticmethod
    def arp2_to_mother_distance(): # was 4.17 nm
        return np.linalg.norm(ActinStructure.mother_positions[3] - ActinStructure.arp2_position)

    @staticmethod
    def arp3_to_mother_distance(): # was 8.22 nm
        return np.linalg.norm(ActinStructure.mother_positions[4] - ActinStructure.arp3_position)

    @staticmethod
    def arp2_to_arp3_distance(): # was 4.18 nm
        return np.linalg.norm(ActinStructure.arp3_position - ActinStructure.arp2_position)

    @staticmethod
    def arp2_to_daughter_distance(): # arp3 to daughter was 4.19 nm
        return np.linalg.norm(ActinStructure.daughter_positions[0] - ActinStructure.arp2_position)

    @staticmethod
    def actin_to_actin_angle(): # was 1.48 rad
        angles = []
        for i in range(len(ActinStructure.mother_positions)-2):
            v1 = ActinStructure.mother_positions[i] - ActinStructure.mother_positions[i + 1]
            v2 = ActinStructure.mother_positions[i + 2] - ActinStructure.mother_positions[i + 1]
    ...
    def actin_to_actin_dihedral_angle(): # was 2.80 rad
        ...
        for i in range(len(ActinStructure.mother_positions)-3):
            v1 = ActinStructure.mother_positions[i] - ActinStructure.mother_positions[i + 1]
            v2 = ActinStructure.mother_positions[i + 3] - ActinStructure.mother_positions[i + 2]
            angles.append(ReaddyUtil.get_angle_between_vectors(v1, v2))
        return np.mean(np.array(angles))
