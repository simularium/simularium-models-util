...
from .microtubules_reactions import MICROTUBULES_REACTIONS
...
class MicrotubulesAnalyzer:
    ...
    def get_protofilaments(frame_particle_data):
        ...
        for particle_id in frame_particle_data["particles"]:
            ...
            plus_end_neighbor_id, minus_end_neighbor_id = MicrotubulesAnalyzer.get_plus_and_minus_end_neighbors(
                particle_id,
                frame_particle_data,
                )
            ...
            while plus_end_neighbor_id is not None:
                ...
                plus_end_neighbor_id, _ = MicrotubulesAnalyzer.get_plus_and_minus_end_neighbors(
    ...
    def get_plus_and_minus_end_neighbors(
        ...
        [x_suffix, y_suffix] = MicrotubulesUtil.get_polymer_indices(particle["type_name"])
        ...
        for neighbor_id in tubulin_neighbor_ids:
            ...
            if neighbor_x == plus_end_suffixes[0] and neighbor_y == plus_end_suffixes[1]:
                plus_end_neighbor_id = neighbor_id
                continue
            if neighbor_x == minus_end_suffixes[0] and neighbor_y == minus_end_suffixes[1]:
    ...
    def analyze_protofilament_lengths(monomer_data):
        ...
        result = [lengths_at_time + [None]*(max_len-len(lengths_at_time)) for lengths_at_time in result]
